...
public class Graph {
    ...
    public ArrayList<Integer> findEulerTour()
    {
        ...
        // add tour starting from oddv
        nodes.add(u);
        findEulerUtil(nodes,u);
        //System.out.println();
    ...
    private void findEulerUtil(ArrayList<Integer> nodes,Integer u)
    {
